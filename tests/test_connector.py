...
from cbopensource.connectors.wildfire.bridge import WildfireConnector, WildfireProvider
import os
import sys
import tempfile
...
class WildfireTest(unittest.TestCase):
    def setUp(self):
        ...
        self.daemon = WildfireConnector('wildfire-test',
